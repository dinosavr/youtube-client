...
export class SettingService {
  ...
  public readonly YOUTUBE_URL_SEARCH: string = `https://www.googleapis.com/youtube/v3/search?key=${this.YOUTUBE_API_KEY}&type=video&part=snippet&maxResults=${this.YOUTUBE_MAX_RESULTS}&q=porshe`;
