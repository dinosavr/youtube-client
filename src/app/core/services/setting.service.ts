...
export class SettingService {
  ...
  public readonly YOUTUBE_URL_VIDEOS: string = `https://www.googleapis.com/youtube/v3/videos?key=${this.YOUTUBE_API_KEY}&part=snippet,statistics&id=nq4aU9gmZQk,REu2BcnlD34,qbPTdW7KgOg`;
  // public readonly YOUTUBE_URL_VIDEOS: string = `https://www.googleapis.com/youtube/v3/videos?key=AIzaSyBE6DQJ01x34_wtbSQMcy-vwN1rPtXio3c&part=snippet,statistics&id=nq4aU9gmZQk,REu2BcnlD34,qbPTdW7KgOg`;
